...
export default function About() {
  return (
    <section className="h-[89vh] w-full flex justify-center items-center relative max-2xl:my-20" id="about">
      <h2 className="relative  text-6xl max-sm:text-lg">
        ...
        <img src={aboutImg3} alt="aboutImg3" className="w-34 absolute top-20 right-44 max-sm:hidden" />
        <img src={aboutImg1} alt="aboutImg1" className="w-[20rem] absolute bottom-10 max-sm:w-[10rem] max-sm:bottom-48 max-sm:left-10" />
        <img src={aboutImg4} alt="aboutImg4" className="w-[15rem] absolute bottom-0 left-0 max-sm:w-[10rem] " />
        <img src={aboutImg5} alt="aboutImg5" className="w-[15rem] absolute bottom-0 right-0 max-sm:w-[10rem] max-sm:h-[15rem]"  />
    </section>
  );
}
